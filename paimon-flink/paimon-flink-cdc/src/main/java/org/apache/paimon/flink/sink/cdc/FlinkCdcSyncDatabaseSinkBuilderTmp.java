 ...
 */
public class FlinkCdcSyncDatabaseSinkBuilderTmp<T> {
    ...
    public FlinkCdcSyncDatabaseSinkBuilderTmp<T> withInput(DataStream<T> input) {
        this.input = input;
        return this;
    }

    public FlinkCdcSyncDatabaseSinkBuilderTmp<T> withParserFactory(
            EventParser.Factory<T> parserFactory) {
        this.parserFactory = parserFactory;
        return this;
    }

    public FlinkCdcSyncDatabaseSinkBuilderTmp<T> withTables(List<FileStoreTable> tables) {
        this.tables = tables;
        return this;
    }

    public FlinkCdcSyncDatabaseSinkBuilderTmp<T> withTableOptions(Map<String, String> options) {
        return withTableOptions(Options.fromMap(options));
    }

    public FlinkCdcSyncDatabaseSinkBuilderTmp<T> withTableOptions(Options options) {
    ...
    //public FlinkCdcSyncDatabaseSinkBuilderTmp<T> withDatabase(String database) {
    //    this.database = database;
    //    return this;
    //}

    public FlinkCdcSyncDatabaseSinkBuilderTmp<T> withCatalogLoader(Catalog.Loader catalogLoader) {
        this.catalogLoader = catalogLoader;
        return this;
    }

    public FlinkCdcSyncDatabaseSinkBuilderTmp<T> withMode(MultiTablesSinkMode mode) {
        this.mode = mode;
        return this;
    }
