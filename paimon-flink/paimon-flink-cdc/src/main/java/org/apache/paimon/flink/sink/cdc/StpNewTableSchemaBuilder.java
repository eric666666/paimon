 ...
 */
public class StpNewTableSchemaBuilder implements Serializable {

    private final Map<String, String> tableConfig;
    private final boolean caseSensitive;
    private final CdcMetadataConverter[] metadataConverters;

    public StpNewTableSchemaBuilder(
    ...
    public Optional<Schema> build(StpRichCdcMultiplexRecord record) {
