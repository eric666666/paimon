...
public abstract class SynchronizationActionBaseTmp extends ActionBase {
    ...
    public SynchronizationActionBaseTmp(
            String warehouse,
    ...
    public SynchronizationActionBaseTmp withTableConfig(Map<String, String> tableConfig) {
        this.tableConfig = tableConfig;
        return this;
    }

    public SynchronizationActionBaseTmp withTypeMapping(TypeMapping typeMapping) {
        this.typeMapping = typeMapping;
        return this;
    }

    public SynchronizationActionBaseTmp withMetadataColumns(List<String> metadataColumns) {
    ...
    public void build() throws Exception {
        ...
        EventParser.Factory<StpRichCdcMultiplexRecord> parserFactory = buildEventParserFactory();
    ...
    protected abstract FlatMapFunction<CdcSourceRecord, StpRichCdcMultiplexRecord> recordParse();

    protected abstract EventParser.Factory<StpRichCdcMultiplexRecord> buildEventParserFactory();
