 ...
 */
public class SparkMixedSessionCatalog extends SparkBaseCatalog implements CatalogExtension {

    private static final Logger LOG = LoggerFactory.getLogger(SparkMixedSessionCatalog.class);
    ...
    public void renameTable(Identifier from, Identifier to)
        ...
        } else if (icebergCatalog.tableExists(from)) {
    ...
    protected TableCatalog buildSparkCatalog(String name, CaseInsensitiveStringMap options) {
        org.apache.iceberg.spark.SparkCatalog newCatalog = new org.apache.iceberg.spark.SparkCatalog();
